 ...
 */
class StorelocatorControllerGeocoder extends StorelocatorController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Geocoder', 'StorelocatorModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_storelocator&view=geocoderform&layout=edit', false));
	}
