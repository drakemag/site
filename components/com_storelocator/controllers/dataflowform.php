 ...
 */
class StorelocatorControllerDataflowForm extends StorelocatorController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('DataflowForm', 'StorelocatorModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_storelocator&view=dataflow&layout=edit', false));
	}
