...
$category = $categories->get($this->state->get('filter.category_id', 'root'));
?>
<div id="cj-wrapper" class="polls<?php echo $this->pageclass_sfx;?>">
	...
	<?php echo JLayoutHelper::render($layout.'.polls_list', array('items'=>$this->items, 'state'=>$this->state, 
			'params'=>$this->params, 'pagination'=>$this->pagination, 'heading'=>$this->heading, 'viewName'=>$this->viewName), '', array('debug'=>false)); ?>
</div>