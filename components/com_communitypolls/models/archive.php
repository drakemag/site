...
class CommunityPollsModelArchive extends CommunityPollsModelPolls
{
	public $_context = 'com_communitypolls.archive';
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$limit = $app->getUserStateFromRequest('com_communitypolls.archive.list' . $itemid . '.limit', 'limit', $params->get('display_num'), 'uint');
	...
	protected function getListQuery()
	{
		...
		$queryDate = CommunityPollsHelperQuery::getQueryDate($pollOrderDate);
