...
class ccommentViewComments extends JViewLegacy
{
	...
	public function display($tpl = null) {
		...
		$fields = $customFieldsModel->getFields('com_comment', $this->config->id);

		$this->customfieldsForm = new JForm('customfields', array('control' => 'jform'));
		$this->customfieldsForm->load(CompojoomFormCustom::generateFormXML($fields));
