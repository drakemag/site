        ...
        try {
            ...
            if (!$queueCount && !$this->deepscancomplete) {
                ...
                $sql = "SELECT id FROM bf_files
                            ...
                            (
                                ...
                                AND filewithpath NOT LIKE '%.js'                -- temp! not auditing JS files for a while
                ...
                $whitelist    = file_get_contents('https://cdn.myjoomla.com/public/global/whitelist');
                ...
                $hacklist    = file_get_contents('https://cdn.myjoomla.com/public/global/hacklist');
            ...
            while ($this->db->loadResult() > 0 && $this->_timer->getTimeLeft() > _BF_CONFIG_DEEPSCAN_TIMER_ONE) {
                ...
                while (count($files_to_scan) && $this->_timer->getTimeLeft() > _BF_CONFIG_DEEPSCAN_TIMER_ONE) {
                    ...
                    bfLog::log('Files left in this pop = ' . count($files_to_scan));
                    ...
                    if (!file_exists(JPATH_BASE . $file_to_scan->filewithpath)) {
                        ...
                        bfLog::log('SKIP: FILE WAS ANIMATED JS - skipping ' . $file_to_scan->filewithpath);
                        $skip = -2;
