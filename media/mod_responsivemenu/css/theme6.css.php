...
.responsiveMenuTheme6 span.opener{display:none;}
/*
---------------------------------------------------------------
...
===================*/
	...
	.sm-blue a:hover, .sm-blue a:focus, .sm-blue a:active, .sm-blue a.highlighted , .sm-blue span.separator:hover, .sm-blue span.navHeader:hover {
	...
	.sm-blue li.active > a, .sm-blue li.active > span.separator, .sm-blue li.active > span.navHeader {background: <?php echo $mobileMenu;?>;
...
===================*/
	...
	.sm-blue li.active > a, .sm-blue li.active > span.separator, .sm-blue li.active > span.navHeader {background: <?php echo $mobileMenu;?> !important;
		background-image:-moz-linear-gradient(top,<?php echo $menuBG;?> 0%,<?php echo $mobileMenu;?> 100%);
		background-image:-webkit-gradient(linear,left top,left bottom,color-stop(0%,<?php echo $menuBG;?>),color-stop(100%,<?php echo $mobileMenu;?>));
		background-image:-webkit-linear-gradient(top,<?php echo $menuBG;?> 0%,<?php echo $mobileMenu;?> 100%);
		background-image:-o-linear-gradient(top,<?php echo $menuBG;?> 0%,<?php echo $mobileMenu;?> 100%);
...
#responsiveMenuTheme6 {
		position:relative;
		z-index:9999;
		width:12em;
	}
	#responsiveMenuTheme6 ul {
		width:12em; /* fixed width only please - you can use the "subMenusMinWidth"/"subMenusMaxWidth" script options to override this if you like */
	}
}
.responsiveMenuTheme6 li img, .responsiveMenuTheme6 li span.image-title {vertical-align: middle;}
.responsiveMenuTheme6 li img {margin-right: 3px;}