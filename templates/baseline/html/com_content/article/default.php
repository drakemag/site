...
?>
<?php // this is the new location of fullt text image -- to above the title -20141117 - rgs ?>
	...
	<?php endif; ?>
<?php // end new location of fullt text image -- to above the title -20141117 - rgs ?>
	...
	<?php 
		...
		/* 144 = 5 minute awards LP */
		if($itemid != '144' && $itemid != '196' && $itemid != '206'){?>
		    <div class="add_this">
...
<?php /* old location for full text image - 2014117 - rgs ?>
	<?php if ($params->get('access-view')):?>
	<?php if (isset($images->image_fulltext) && !empty($images->image_fulltext)) : ?>
	<?php $imgfloat = (empty($images->float_fulltext)) ? $params->get('float_fulltext') : $images->float_fulltext; ?>
...
<?php
	...
	*/
	...
	byline($this_parent_id,$this_item_author);
?>
