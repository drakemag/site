...
<body id="<?php echo $pageclass; ?>">
 ...
 <div id="wrapper">
 	...
 	<div id="focus">
		<style>
			#yeti_super {
				width: 100%; height: 394px; display: block;	
				padding: 20px 20px 16px;
				border: 2px solid #0D1C21;
				...
				#yeti_super .yeti_content {
					...
					#yeti_super .yeti_content img {
						float: right;
						text-align: right;
						clear: both;
					}
					#yeti_super .yeti_content h3 a,
					#yeti_super .yeti_content .text a{
						color: #fff !important;
						text-decoration: none !important;
					}
					#yeti_super .yeti_content a:hover img {
						opacity: .9 !important;
					}
					#yeti_super .yeti_content h3 a:hover,
					#yeti_super .yeti_content .text a:hover{
						color: #efefef !important;
						text-decoration: none !important;
					}
					#yeti_super .yeti_content h3,
					#yeti_super .yeti_content .text {
						float: left;
						clear: both;
						color: #fff;
						text-align: left;
		...
		<div id="yeti_super">
			<iframe width="617" height="347" src="https://www.youtube.com/embed/W71ow-KI2Eg" frameborder="0" allowfullscreen></iframe>
			<div class="yeti_content">
				<div>sponsored content</div>
				<a href="http://yeticoolers.com/yeti-videos/engler/" target="_blank"><img src="/adserver/images/yeti_logo.png" alt="YETI Coolers" /></a>
				<h3><a href="http://yeticoolers.com/yeti-videos/engler/" target="_blank">A Guide’s Guide</a></h3>
				<div class="text"><a href="http://yeticoolers.com/yeti-videos/engler/" target="_blank">As a kid, Mark Engler had a dream—that one day he’d live this life, hunting and fishing everyday. In order to achieve it he spent decades exploring rivers and tying some of the most effective flies that Four Corners’ trout have ever seen. Here, catch up with Engler and meet angling protégé Les Vance, who’s about to realize that following in the master’s footsteps may be a rewarding path, but like any dream pursuit, it’s going to be a challenge.</a></div>
			</div>
		</div>
 		<?php
			 $menu2 = &JSite::getMenu();
