...
if (($this->error->code) == '404') {
	header('Location: index.php?option=com_content&view=article&id=5&Itemid=7');
	exit;
}
if (($this->error->code) == '403') {
	header('Location: index.php?option=com_content&view=article&id=6&Itemid=8');
	exit;
}
if (($this->error->code) == '500') {
	header('Location: index.php?option=com_content&view=article&id=7&Itemid=9');
	exit;
}
if (($this->error->code) == '401') {
	header('Location: index.php?option=com_content&view=article&id=9&Itemid=10');
	exit;
}
