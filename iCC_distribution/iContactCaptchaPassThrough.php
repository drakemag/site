...
if (PhpCaptcha::Validate($_POST['user_code'])) {
	...
	if ($writeToDB) {
		...
		$admin_email = "dawn@drakemag.com"; //The email address you want the POSTDATA sent to.
		$subject = "Drake Magazine - Distribution Information Request" . " - " . $timeOfDay; //Subject of the emails sent by this script.
