...
<div class="rp-poll-wrapper rp-<?php echo $rand;?>">
	...
	<h4 class="page-title"><?php echo CJFunctions::escape($poll->title);?></h4>
	
	<?php if($show_description == 1 && !empty($poll->description)):?>
	<?php if($desc_length > 0):?>
	<div class="rp-poll-description"><?php echo CJFunctions::substrws(strip_tags(CJFunctions::process_html($poll->description, $bbcode)), $desc_length);?></div>
	<?php else:?>
	<div class="rp-poll-description"><?php echo strip_tags(CJFunctions::process_html($poll->description, $bbcode));?></div>
	<?php endif;?>
	<?php endif;?>
		...
		<div class="rp-form-wrapper">
			...
			<div class="rp-answer <?php echo ($i == count($poll->answers)-1 && $poll->custom_answer != '1') ? 'no-border-bottom' : ''?>">
				...
				<label class="<?php echo $poll->type;?>">
					...
					<?php else:?>
					<?php echo CJFunctions::escape($answer->title);?>
					<?php endif;?>
				</label>
