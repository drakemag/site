...
if(version_compare(JVERSION,'1.6.0','ge')) {
	...
	$document->addStyleSheet("media/mod_responsivemenu/css/theme2.css.php?maxMobileWidth=".$maxMobileWidth."&amp;menuBG=".$menuBG."&amp;textColor=".$textColor."&amp;textColor2=".$textColor2);
	if($rtlLayout){
		$document->addStyleSheet("media/mod_responsivemenu/css/theme2-rtl.css.php?maxMobileWidth=".$maxMobileWidth."&amp;menuBG=".$menuBG."&amp;textColor=".$textColor);
	}
	$document->addScript("modules/mod_responsivemenu/js/jquery.easing.1.3.js",'text/javascript', true);
	$document->addScript("modules/mod_responsivemenu/js/theme2.js",'text/javascript', true);
	?>
	...
	<ul id="responsiveMenu<?php echo $module->id; ?>" class="responsiveMenuTheme2 <?php echo $class_sfx;?> <?php echo ($rtlLayout) ? 'rtlLayout' : ''; ?>"<?php
		$tag = '';
