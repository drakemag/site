 ...
 * View to edit
 */
class StorelocatorViewLocation extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= StorelocatorHelper::getActions();

		JToolBarHelper::title(JText::_('COM_STORELOCATOR_TITLE_LOCATION'), 'location.png');
