 ...
 */
class StorelocatorViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		StorelocatorHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_STORELOCATOR_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_storelocator&view=categories');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_STORELOCATOR_CATEGORIES_NAME'),
		'a.markerid' => JText::_('COM_STORELOCATOR_CATEGORIES_MARKERID'),
