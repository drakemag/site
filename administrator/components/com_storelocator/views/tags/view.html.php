 ...
 */
class StorelocatorViewTags extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		StorelocatorHelper::addSubmenu('tags');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_STORELOCATOR_TITLE_TAGS'), 'tags.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_storelocator&view=tags');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_STORELOCATOR_TAGS_NAME'),
		'a.marker_id' => JText::_('COM_STORELOCATOR_TAGS_MARKER_ID'),
