 ...
 */
class StorelocatorViewMarkers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		StorelocatorHelper::addSubmenu('markers');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_STORELOCATOR_TITLE_MARKERS'), 'markers.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_storelocator&view=markers');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_STORELOCATOR_MARKERS_NAME'),
		'a.image_url' => JText::_('COM_STORELOCATOR_MARKERS_IMAGE_URL'),
		);
	}
