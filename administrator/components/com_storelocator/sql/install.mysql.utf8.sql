CREATE TABLE IF NOT EXISTS `#__storelocator_locations` (
...
`cust1` VARCHAR(255)  NOT NULL ,
`cust2` VARCHAR(255)  NOT NULL ,
`cust3` VARCHAR(255)  NOT NULL ,
`cust4` VARCHAR(255)  NOT NULL ,
`cust5` VARCHAR(255)  NOT NULL ,
...
KEY `idx_lat` (`lat`),
KEY `idx_long` (`long`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT COLLATE=utf8_general_ci;

CREATE TABLE IF NOT EXISTS `#__storelocator_cats` (
`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
`name` VARCHAR(255)  NOT NULL ,
`markerid` INT NOT NULL DEFAULT '1',
`ordering` INT(11)  NOT NULL  DEFAULT '0',
PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT COLLATE=utf8_general_ci;

REPLACE INTO `#__storelocator_cats` (`id`,`name`) VALUES (1,'General');
